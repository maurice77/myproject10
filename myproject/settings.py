...
SECRET_KEY = 'f4q7sw$7#=xz5z=(8jir6_9p_f)ail_vfb(=k+mum8t=$&-ij1'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'myproject10_db', # nombre de la base de datos, se creará en el servidor de Postgres a continuación
